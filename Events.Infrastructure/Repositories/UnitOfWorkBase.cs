...
namespace Events.Infrastructure.Repositories
{
    public class UnitOfWorkBase : IUnitOfWork
    {
        ...
        public IRepositoryBase<ChairType> _chairTypeRepository;
        public IRepositoryBase<ChairType> ChairTypeRepository => _chairTypeRepository ?? (_chairTypeRepository = new RepositoryBase<ChairType>(_context));
