...
namespace Events.Api.Controllers
{
    ...
    public class SecondTitleController : ControllerBase
    {
        ...
        [HttpGet("get-all")]
        public async Task<Response<PagedResult<GetTitleSecondDto>>> GetSecondTitles(PagintationRequest request)
        {
            var result = await _mediator.Send(new GetTitleSecond(request));
            return result;
        }
        [HttpGet("get-one")]
